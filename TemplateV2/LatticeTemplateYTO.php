...
class LatticeTemplateYTO extends LatticeTemplateBase
{
    /**
     * 状态1模板
    ...
    )
    {
        ...
        // {
        //     $lattice->text($orderInfo['transfer'], 12, [$x, -20, 'center-left'], 1, 0, 0, 1);
        // }
        // 打印时间
        $date = Date('Y-m-d H:i');
        ...
        // 物流ID
        $lattice->text('圆通 ' . $orderInfo['courier_number'], 12, [$x - 10, 17, 'center-right'], 0, 0, 0, 1);
    ...
    )
    {
        ...
        $y = 1;
        // 物流公司
        $express = '圆通快递' . $data['order_info']['courier_number'];
